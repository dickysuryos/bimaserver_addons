...
-- -- Add a hint for the command
-- TriggerEvent('chat:addSuggestion', '/race', 'command untuk balapan liar, pastikan kalian memiliki record rute, bisa di cek menggunakan list , jika tidak ada makan buat record dahulu', {
    
-- })


-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race record', 'record rute balapan dan buka maps tandai rute', {
    {name = 'enter', help = 'enter saja dan tandai di map'},
})

-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race save', 'menyimpan rute untuk di gunakan kembali', {
    {name = 'beri nama rute mu', help = 'berikan nama rute mu'},
})

-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race start', 'memulai race dengan taruhan dan waktu tunggu', {
    {name = 'jumlah taruhan', help = 'biaya yang di bayar'},
    {name = 'waktu tunggu', help = 'menunggu waktu race dimulai'}
})


-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race load', 'mengatur race menggunakan rute yang di simpan', {
    {name = 'nama rute mu', help = 'berikan nama rute mu'},
})



-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race list', 'memberi list nama record rute yang tersimpan', {
    {name = 'enter', help = 'enter saja'},
})

-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race delete', 'menghapus rute yang tersimpan', {
    {name = 'nama rute mu', help = 'berikan nama rute mu'},
})


-- Add a hint for the command
TriggerEvent('chat:addSuggestion', '/race cancel', 'Cancel the race', {
    {name = 'enter', help = 'enter aja'},
})
