...
Config.ReviveChance = {
    enable = false, -- Set false that you always get revived
    chance = 100, -- Percent to get revived

    tryagain = true, -- Set to true if the NPC should try it again if he failed
...
Config.ProgressBar = function()
    exports["esx_progressbar"]:Progressbar('Mengobati...',Config.ReviveDuration * 1000)
end
